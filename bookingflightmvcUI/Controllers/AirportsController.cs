...
namespace bookingflightmvcUI.Controllers
{
    public class AirportsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,AirportName")] Airport airport)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,AirportName")] Airport airport)
        {
            if (id != airport.Id)
            {
                return NotFound();
        ...
        {
            List<Airport> airport = await _context.Airports.ToListAsync();
            if (airport.Any())
            {
                return Ok(new MyResponse(false, "Successfully", airport));
            }

            return Ok(NotFound(new MyResponse(true, "UnSuccessfully", null)));
        }
    }
}
